      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            <li>
                <a href="indexkaryawan.php">Home</a>
            </li>
            <li>
                  ...
                  <tbody id="myTable">
                       <?php
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="form-edit.php?id=<?php echo $r['NIP'] ?>" class="btn btn-default">Edit Data Karyawan</a>
                            <a href="inputdatacuti.php?id=<?php echo $r['NIP'] ?>" class="btn btn-default">Input Cuti</a>
                            <a href="hapuskaryawan.php?id=<?php echo $r['NIP'] ?>" class="btn btn-default" onclick="return confirm('Apakah yakin ingin di hapus?');">Hapus</a>
                          </td>
                        </tr>
                        <?php
                          $no++; 
